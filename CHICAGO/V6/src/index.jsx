...
function Caption(){
  ...
  return <div style={{
    position:'absolute',
    left:70,right:70,
    top:endMode?46:undefined,
    bottom:endMode?undefined:26,
    textAlign:'center',
...
function EditorialCard({card}){
  ...
  return <div style={{position:'absolute',inset:0,opacity:op,zIndex:20,pointerEvents:'none'}}>
    {/* V6: intentionally NO background, NO gradient, NO panel. */}
...
registerRoot(()=> <Composition id="ChicagoV6" component={Film} durationInFrames={32268} fps={25} width={960} height={540}/>);
