...
def mix_final_from_stems(video,music_bed,vo_path,sfx_path,out,total,tmpdir):
    ...
    fc=(
        ...
        "pan=stereo|c0=c0|c1=c0,volume=0.42,"
        f"volume=0.12:enable='between(t,{1115.376-COLD_OPEN_END:.3f},{rest:.3f})'[sfx];"
        ...
        "[vo_mix][sfx][duck]amix=inputs=3:weights='1 0.55 1':normalize=0,alimiter=limit=0.89[rest];"
